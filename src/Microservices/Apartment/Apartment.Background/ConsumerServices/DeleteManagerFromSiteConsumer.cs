...
public class DeleteManagerFromSiteConsumer
{
    ...
    public async Task ConsumeAsync(IModel channel)
    {
        ...
        channel.QueueDeclare(queue: QueueConstant.DELETE_MANAGER, durable: true, exclusive: false, autoDelete: false);
        ...
        channel.BasicConsume(queue: QueueConstant.DELETE_MANAGER,
            autoAck: false,
            consumer: consumer);
